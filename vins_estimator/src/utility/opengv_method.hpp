...
namespace opengv
{
        ...
        Eigen::Matrix<double, 1, 3> &jacobian)
    {
        ...
        double c_jac1 =
            -2.0 * M(0, 2) * M_jac1(0, 2) - 2.0 * M(1, 2) * M_jac1(1, 2) - 2.0 * M(0, 1) * M_jac1(0, 1) + M_jac1(0, 0) * M(1, 1) + M(0, 0) * M_jac1(1, 1) + M_jac1(0, 0) * M(2, 2) + M(0, 0) * M_jac1(2, 2) + M_jac1(1, 1) * M(2, 2) + M(1, 1) * M_jac1(2, 2);
        double c_jac2 =
            -2.0 * M(0, 2) * M_jac2(0, 2) - 2.0 * M(1, 2) * M_jac2(1, 2) - 2.0 * M(0, 1) * M_jac2(0, 1) + M_jac2(0, 0) * M(1, 1) + M(0, 0) * M_jac2(1, 1) + M_jac2(0, 0) * M(2, 2) + M(0, 0) * M_jac2(2, 2) + M_jac2(1, 1) * M(2, 2) + M(1, 1) * M_jac2(2, 2);
        double c_jac3 =
            -2.0 * M(0, 2) * M_jac3(0, 2) - 2.0 * M(1, 2) * M_jac3(1, 2) - 2.0 * M(0, 1) * M_jac3(0, 1) + M_jac3(0, 0) * M(1, 1) + M(0, 0) * M_jac3(1, 1) + M_jac3(0, 0) * M(2, 2) + M(0, 0) * M_jac3(2, 2) + M_jac3(1, 1) * M(2, 2) + M(1, 1) * M_jac3(2, 2);
        double d =
            M(1, 1) * pow(M(0, 2), 2) + M(0, 0) * pow(M(1, 2), 2) + M(2, 2) * pow(M(0, 1), 2) -
            M(0, 0) * M(1, 1) * M(2, 2) - 2 * M(0, 1) * M(1, 2) * M(0, 2);
        double d_jac1 =
            M_jac1(1, 1) * pow(M(0, 2), 2) + M(1, 1) * 2 * M(0, 2) * M_jac1(0, 2) + M_jac1(0, 0) * pow(M(1, 2), 2) + M(0, 0) * 2.0 * M(1, 2) * M_jac1(1, 2) + M_jac1(2, 2) * pow(M(0, 1), 2) + M(2, 2) * 2.0 * M(0, 1) * M_jac1(0, 1) - M_jac1(0, 0) * M(1, 1) * M(2, 2) - M(0, 0) * M_jac1(1, 1) * M(2, 2) - M(0, 0) * M(1, 1) * M_jac1(2, 2) - 2.0 * (M_jac1(0, 1) * M(1, 2) * M(0, 2) + M(0, 1) * M_jac1(1, 2) * M(0, 2) + M(0, 1) * M(1, 2) * M_jac1(0, 2));
        double d_jac2 =
            M_jac2(1, 1) * pow(M(0, 2), 2) + M(1, 1) * 2 * M(0, 2) * M_jac2(0, 2) + M_jac2(0, 0) * pow(M(1, 2), 2) + M(0, 0) * 2.0 * M(1, 2) * M_jac2(1, 2) + M_jac2(2, 2) * pow(M(0, 1), 2) + M(2, 2) * 2.0 * M(0, 1) * M_jac2(0, 1) - M_jac2(0, 0) * M(1, 1) * M(2, 2) - M(0, 0) * M_jac2(1, 1) * M(2, 2) - M(0, 0) * M(1, 1) * M_jac2(2, 2) - 2.0 * (M_jac2(0, 1) * M(1, 2) * M(0, 2) + M(0, 1) * M_jac2(1, 2) * M(0, 2) + M(0, 1) * M(1, 2) * M_jac2(0, 2));
        double d_jac3 =
            M_jac3(1, 1) * pow(M(0, 2), 2) + M(1, 1) * 2 * M(0, 2) * M_jac3(0, 2) + M_jac3(0, 0) * pow(M(1, 2), 2) + M(0, 0) * 2.0 * M(1, 2) * M_jac3(1, 2) + M_jac3(2, 2) * pow(M(0, 1), 2) + M(2, 2) * 2.0 * M(0, 1) * M_jac3(0, 1) - M_jac3(0, 0) * M(1, 1) * M(2, 2) - M(0, 0) * M_jac3(1, 1) * M(2, 2) - M(0, 0) * M(1, 1) * M_jac3(2, 2) - 2.0 * (M_jac3(0, 1) * M(1, 2) * M(0, 2) + M(0, 1) * M_jac3(1, 2) * M(0, 2) + M(0, 1) * M(1, 2) * M_jac3(0, 2));
        ...
        Eigen::Matrix<T, 1, 3> &jacobian)
    {
        ...
        T c =
            ...
            M(0, 0) * M(1, 1) + M(0, 0) * M(2, 2) + M(1, 1) * M(2, 2);
        T c_jac1 =
            -2.0 * M(0, 2) * M_jac1(0, 2) - T(2.0) * M(1, 2) * M_jac1(1, 2) - 2.0 * M(0, 1) * M_jac1(0, 1) + M_jac1(0, 0) * M(1, 1) + M(0, 0) * M_jac1(1, 1) + M_jac1(0, 0) * M(2, 2) + M(0, 0) * M_jac1(2, 2) + M_jac1(1, 1) * M(2, 2) + M(1, 1) * M_jac1(2, 2);
        T c_jac2 =
            -2.0 * M(0, 2) * M_jac2(0, 2) - T(2.0) * M(1, 2) * M_jac2(1, 2) - 2.0 * M(0, 1) * M_jac2(0, 1) + M_jac2(0, 0) * M(1, 1) + M(0, 0) * M_jac2(1, 1) + M_jac2(0, 0) * M(2, 2) + M(0, 0) * M_jac2(2, 2) + M_jac2(1, 1) * M(2, 2) + M(1, 1) * M_jac2(2, 2);
        T c_jac3 =
            -2.0 * M(0, 2) * M_jac3(0, 2) - T(2.0) * M(1, 2) * M_jac3(1, 2) - 2.0 * M(0, 1) * M_jac3(0, 1) + M_jac3(0, 0) * M(1, 1) + M(0, 0) * M_jac3(1, 1) + M_jac3(0, 0) * M(2, 2) + M(0, 0) * M_jac3(2, 2) + M_jac3(1, 1) * M(2, 2) + M(1, 1) * M_jac3(2, 2);
        T d =
            M(1, 1) * ceres::pow(M(0, 2), 2) + M(0, 0) * ceres::pow(M(1, 2), 2) + M(2, 2) * ceres::pow(M(0, 1), 2) -
            M(0, 0) * M(1, 1) * M(2, 2) - T(2.0) * M(0, 1) * M(1, 2) * M(0, 2);
        T d_jac1 =
            M_jac1(1, 1) * ceres::pow(M(0, 2), 2) + M(1, 1) * T(2.0) * M(0, 2) * M_jac1(0, 2) + M_jac1(0, 0) * ceres::pow(M(1, 2), 2) + M(0, 0) * 2.0 * M(1, 2) * M_jac1(1, 2) + M_jac1(2, 2) * ceres::pow(M(0, 1), 2) + M(2, 2) * 2.0 * M(0, 1) * M_jac1(0, 1) - M_jac1(0, 0) * M(1, 1) * M(2, 2) - M(0, 0) * M_jac1(1, 1) * M(2, 2) - M(0, 0) * M(1, 1) * M_jac1(2, 2) - T(2.0) * (M_jac1(0, 1) * M(1, 2) * M(0, 2) + M(0, 1) * M_jac1(1, 2) * M(0, 2) + M(0, 1) * M(1, 2) * M_jac1(0, 2));
        T d_jac2 =
            M_jac2(1, 1) * ceres::pow(M(0, 2), 2) + M(1, 1) * T(2.0) * M(0, 2) * M_jac2(0, 2) + M_jac2(0, 0) * ceres::pow(M(1, 2), 2) + M(0, 0) * 2.0 * M(1, 2) * M_jac2(1, 2) + M_jac2(2, 2) * ceres::pow(M(0, 1), 2) + M(2, 2) * 2.0 * M(0, 1) * M_jac2(0, 1) - M_jac2(0, 0) * M(1, 1) * M(2, 2) - M(0, 0) * M_jac2(1, 1) * M(2, 2) - M(0, 0) * M(1, 1) * M_jac2(2, 2) - T(2.0) * (M_jac2(0, 1) * M(1, 2) * M(0, 2) + M(0, 1) * M_jac2(1, 2) * M(0, 2) + M(0, 1) * M(1, 2) * M_jac2(0, 2));
        T d_jac3 =
            M_jac3(1, 1) * ceres::pow(M(0, 2), 2) + M(1, 1) * T(2.0) * M(0, 2) * M_jac3(0, 2) + M_jac3(0, 0) * ceres::pow(M(1, 2), 2) + M(0, 0) * T(2.0) * M(1, 2) * M_jac3(1, 2) + M_jac3(2, 2) * ceres::pow(M(0, 1), 2) + M(2, 2) * 2.0 * M(0, 1) * M_jac3(0, 1) - M_jac3(0, 0) * M(1, 1) * M(2, 2) - M(0, 0) * M_jac3(1, 1) * M(2, 2) - M(0, 0) * M(1, 1) * M_jac3(2, 2) - T(2.0) * (M_jac3(0, 1) * M(1, 2) * M(0, 2) + M(0, 1) * M_jac3(1, 2) * M(0, 2) + M(0, 1) * M(1, 2) * M_jac3(0, 2));
